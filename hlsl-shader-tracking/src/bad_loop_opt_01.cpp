...
const char*         k_app_name = "bad_loop_opt_01";
...
void init_tiny_renderer(GLFWwindow* window)
{
...
#if defined(TINY_RENDERER_VK)
    // Uses HLSL source
    auto vert = load_file(k_asset_dir + "bad_loop_opt_01.vs.spv");
    auto frag = load_file(k_asset_dir + "bad_loop_opt_01.ps.spv");
    ...
    auto hlsl = load_file(k_asset_dir + "bad_loop_opt_01.hlsl");
    tr_create_shader_program(m_renderer, 
