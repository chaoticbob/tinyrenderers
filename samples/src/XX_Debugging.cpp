...
tr_buffer*          m_debug_dst_counter_buffer = nullptr;
tr_buffer*          m_debug_dst_buffer = nullptr;
...
void init_tiny_renderer(GLFWwindow* window)
{
    ...
    // Debug buffer data
    descriptors[4].type          = tr_descriptor_type_storage_buffer_uav;
    descriptors[4].count         = 1;
    descriptors[4].binding       = 4;
    descriptors[4].shader_stages = tr_shader_stage_comp;
    // Debug buffer counter
    descriptors[5].type          = tr_descriptor_type_storage_buffer_uav;
    descriptors[5].count         = 1;
    descriptors[5].binding       = 5;
