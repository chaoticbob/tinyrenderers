...
const char*         k_app_name = "structs_04";
...
void init_tiny_renderer(GLFWwindow* window)
{
...
#if defined(TINY_RENDERER_VK)
    // Uses HLSL source
    auto vert = load_file(k_asset_dir + "structs_04.vs.spv");
    auto frag = load_file(k_asset_dir + "structs_04.ps.spv");
    ...
    auto hlsl = load_file(k_asset_dir + "structs_04.hlsl");
    tr_create_shader_program(m_renderer, 
