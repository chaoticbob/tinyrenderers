...
void init_tiny_renderer(GLFWwindow* window)
{
    ...
    tr_create_storage_buffer(m_renderer, buffer_size, 0, element_count, struct_stride, 0, tr_buffer_feature_none, &m_compute_src_buffer);
    ...
    struct_stride = 4;
    tr_create_storage_buffer(m_renderer, buffer_size, 0, element_count, struct_stride, 0, tr_buffer_feature_none, &m_compute_dst_buffer);
