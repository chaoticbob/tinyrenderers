...
void init_tiny_renderer(GLFWwindow* window)
{
    ...
    tr_create_pipeline(m_renderer, m_shader, &vertex_layout, m_desc_set_tri, m_renderer->swapchain_render_passes[0], &pipeline_settings, &m_pipeline_tri);
    tr_create_pipeline(m_renderer, m_shader, &vertex_layout, m_desc_set_quad, m_renderer->swapchain_render_passes[0], &pipeline_settings, &m_pipeline_quad);
