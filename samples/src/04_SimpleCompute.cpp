...
const char*         k_app_name = "04_SimpleCompute";
...
void init_tiny_renderer(GLFWwindow* window)
{
    ...
    unsigned char* image_data = stbi_load((k_asset_dir + "box_panel.jpg").c_str(), &image_width, &image_height, &image_channels, required_channels);
    ...
    tr_util_update_texture_uint8(m_renderer->graphics_queue, image_width, image_height, image_row_stride, image_data, required_channels, m_texture, NULL, NULL);
    ...
    tr_create_sampler(m_renderer, &sampler_settings, &m_sampler);
